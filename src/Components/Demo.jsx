  ...
  return (
    <section className="mt-16 w-full max-w-xl">
      <div className="flex flex-col w-full gap-2 "> 
        <form className='relative flex justify-center item-center'
       ...
       <input
        ...
        value={article.url}
        onChange={(e) => SetArticle({... article, url: e.target.value})} /*  ... only ensures url is changed by making shallow copy of article opbject*/
        required
      ...
      <div
      className="my=10 max-w-full flex justify-center
      items-center">
        {isFetching ? (
          <img
           src={ loader }
